...
I modified the *splitting.py* file to implement K-Folds cross-validation in the *split\_data* function instead of the usual train/validation/test splitting.
...
\2) Maximum over the best layers\
...
I tried geometric features above, but they only reduced the resulting metrics, so I didn't use them in the final solution.
